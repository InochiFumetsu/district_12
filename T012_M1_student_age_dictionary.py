...
1. Follow the FDR to implement the function you have been assigned. (Note that FDR was covered in ECOR1041).
  a. You can use “import string” and “from typing import List” only. If you think other libraries are needed, you must ask the TAs for approval. Note: You can treat a CSV file as a text file; just open it with Notepad instead of Excel to check how the data is organized.
  b. Assume that your data does not contain duplicated entries.
  c. Required Filename: Txxx_M1_yyy.py where xxx is your team identifier (e.g., 035) and yyy = {student_age_dictionary, student_health_dictionary, student_school_dictionary, or student_failures_dictionary} based on the function that you are implementing.
